...
public class ProductController {
    ...
    public String details(@PathVariable("id") Long id,
        ...
        List<ProductDto> productDtoList = productService.findAllCategory(product.getCategory().getName());
    ...
    public String filterHighPrice(Model model) {
        ...
        model.addAttribute("title", "Shop Detail");
        model.addAttribute("page", "Shop Detail");
        model.addAttribute("productView", listView);
        model.addAttribute("products", products);
        return "shop-detail";
    }
    ...
    public String searchProduct(@RequestParam("keyword") String keyword, Model model) {
        ...
        List<ProductDto> listView = productService.listViewProducts();
        model.addAttribute("productsView", listView);
        model.addAttribute("categories", categoryDtos);

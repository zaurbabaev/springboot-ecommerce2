...
public class ProductController {
    ...
    public String searchProduct(@PathVariable("pageNo") int pageNo,
        ...
        model.addAttribute("size", products.getSize());
        model.addAttribute("products", "products");
        model.addAttribute("currentsPage", pageNo);
        model.addAttribute("totalPage", products.getTotalPages());
        return "product-result";
    }

    @GetMapping("/add-product")
    public String saveProduct(Principal principal, Model model) {
        if (principal == null) {
            return "redirect:/login";
        }
    ...
    public String saveProduct(@ModelAttribute("productDto") ProductDto productDto,
        ...
        try {
            ...
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("success", "Failed to add new product");
        }
    ...
    public String enabledProduct(Long id,
                                 RedirectAttributes redirectAttributes,
                                 Principal principal) {
        try {
            if (principal == null) {
